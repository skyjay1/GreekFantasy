...
public class PomegranateTreeGrower extends AbstractTreeGrower {
    ...
    private static final ResourceKey<ConfiguredFeature<?, ?>> KEY = ResourceKey.create(BuiltinRegistries.CONFIGURED_FEATURE.key(), new ResourceLocation(GreekFantasy.MODID, "pomegranate_tree"));
