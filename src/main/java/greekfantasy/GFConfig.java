...
//public final ConfigValue<List<? extends String>> FEATURES_DIMENSION_WHITELIST;
  ...
  public GFConfig(final ForgeConfigSpec.Builder builder) {
    ...
    MOB_SPAWNS.put("drakaina", new BiomeWhitelistConfig(builder, "drakaina_spawn", 60, false, endOceanCold));
    MOB_SPAWNS.put("dryad", new BiomeWhitelistConfig(builder, "dryad_spawn", 24, true, forest));
    MOB_SPAWNS.put("empusa", new BiomeWhitelistConfig(builder, "empusa_spawn", 30, false, netherEndOceanIcy));
    ...
    MOB_SPAWNS.put("gorgon", new BiomeWhitelistConfig(builder, "gorgon_spawn", 30, false, netherEndOceanIcy));
