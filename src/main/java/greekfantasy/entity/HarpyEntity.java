...
public class HarpyEntity extends MonsterEntity implements IFlyingAnimal {
  ...
  protected void registerGoals() {
    ...
    this.goalSelector.addGoal(4, new WaterAvoidingRandomFlyingGoal(this, 0.9D) {
      @Override
      public boolean canUse() { return !HarpyEntity.this.isGoingToNest && HarpyEntity.this.getRandom().nextInt(200) == 0 && super.canUse(); }
    });
  ...
  @Override
  protected float getVoicePitch() { return 0.7F + random.nextFloat() * 0.2F; }
