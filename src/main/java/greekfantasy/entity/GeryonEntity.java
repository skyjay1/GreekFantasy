...
public class GeryonEntity extends MonsterEntity {
  ...
  @Override
  protected float getVoicePitch() { return 0.089F; }
  ...
  public byte getGeryonState() { return this.getEntityData().get(STATE).byteValue(); }
  
  public void setGeryonState(final byte state) { this.getEntityData().set(STATE, Byte.valueOf(state)); }
  ...
  class SpawningGoal extends Goal {
    ...
    @Override
    public boolean canUse() { return GeryonEntity.this.isSpawning(); }

    @Override
    public void tick() { GeryonEntity.this.getNavigation().stop(); }
  }
