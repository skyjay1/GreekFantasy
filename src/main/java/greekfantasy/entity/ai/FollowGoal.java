 ...
 * By default, the entity follows only entities which have the same entity type.
 **/
public class FollowGoal extends Goal {
  ...
  public FollowGoal(final MobEntity entityIn, final double speed, final float stopDistanceIn, final float areaSizeIn) {
    this(entityIn, speed, stopDistanceIn, areaSizeIn, (e -> (e != null && e.getType() == entityIn.getType())));
  }
