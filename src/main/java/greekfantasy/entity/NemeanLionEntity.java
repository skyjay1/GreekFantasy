...
public class NemeanLionEntity extends MonsterEntity {
  ...
  @Override
  public double getPassengersRidingOffset() { return super.getPassengersRidingOffset() + 0.805D; }
  ...
  public byte getNemeanState() { return this.getEntityData().get(STATE).byteValue(); }
  
  public void setNemeanState(final byte state) { this.getEntityData().set(STATE, Byte.valueOf(state)); }
  ...
  private class SitGoal extends Goal {
    ...
    @Override
    public boolean canUse() { return NemeanLionEntity.this.isSitting(); }
