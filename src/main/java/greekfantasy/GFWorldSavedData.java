...
public class GFWorldSavedData extends WorldSavedData {
    ...
    private final Map<ChunkPos, Set<BlockPos>> palladiumMap = new HashMap<>();
    ...
    public static boolean validatePalladium(final @Nullable TileEntity te) {
        return false; // TODO /*(te instanceof StatueTileEntity && ((StatueTileEntity) te).getStatueMaterial() == StatueMaterial.WOOD)*/;
    }
