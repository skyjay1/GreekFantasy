...
public final class GFRegistry {
    ...
    public static void registerEntityAttributes(final EntityAttributeCreationEvent event) {
        ...
        event.put(ARA_ENTITY, AraEntity.createAttributes().build());
        event.put(ARACHNE_ENTITY, ArachneEntity.createAttributes().build());
        event.put(ARION_ENTITY, ArionEntity.createAttributes().build());
        event.put(BABY_SPIDER_ENTITY, BabySpiderEntity.createAttributes().build());
        event.put(BRONZE_BULL_ENTITY, BronzeBullEntity.createAttributes().build());
        event.put(CENTAUR_ENTITY, CentaurEntity.createAttributes().build());
        event.put(CERASTES_ENTITY, CerastesEntity.createAttributes().build());
        event.put(CERBERUS_ENTITY, CerberusEntity.createAttributes().build());
        event.put(CHARYBDIS_ENTITY, CharybdisEntity.createAttributes().build());
        event.put(CIRCE_ENTITY, CirceEntity.createAttributes().build());
        event.put(CRETAN_MINOTAUR_ENTITY, CretanMinotaurEntity.createAttributes().build());
        event.put(CYCLOPES_ENTITY, CyclopesEntity.createAttributes().build());
        event.put(CYPRIAN_ENTITY, CyprianEntity.createAttributes().build());
        event.put(DRAKAINA_ENTITY, DrakainaEntity.createAttributes().build());
        event.put(DRYAD_ENTITY, DryadEntity.createAttributes().build());
        event.put(ELPIS_ENTITY, ElpisEntity.createAttributes().build());
        event.put(EMPUSA_ENTITY, EmpusaEntity.createAttributes().build());
        event.put(FURY_ENTITY, FuryEntity.createAttributes().build());
        event.put(GERYON_ENTITY, GeryonEntity.createAttributes().build());
        event.put(GIANT_BOAR_ENTITY, GiantBoarEntity.createAttributes().build());
        event.put(GIGANTE_ENTITY, GiganteEntity.createAttributes().build());
        event.put(GOLDEN_RAM_ENTITY, GoldenRamEntity.createAttributes().build());
        event.put(GORGON_ENTITY, GorgonEntity.createAttributes().build());
        event.put(HARPY_ENTITY, HarpyEntity.createAttributes().build());
        event.put(HYDRA_ENTITY, HydraEntity.createAttributes().build());
        event.put(HYDRA_HEAD_ENTITY, HydraHeadEntity.createAttributes().build());
        event.put(LAMPAD_ENTITY, LampadEntity.createAttributes().build());
        event.put(MAD_COW_ENTITY, MadCowEntity.createAttributes().build());
        event.put(MAKHAI_ENTITY, MakhaiEntity.createAttributes().build());
        event.put(MINOTAUR_ENTITY, MinotaurEntity.createAttributes().build());
        ...
        event.put(SHADE_ENTITY, ShadeEntity.createAttributes().build());
        event.put(SIREN_ENTITY, SirenEntity.createAttributes().build());
        event.put(SPARTI_ENTITY, SpartiEntity.createAttributes().build());
        event.put(TALOS_ENTITY, TalosEntity.createAttributes().build());
        event.put(UNICORN_ENTITY, UnicornEntity.createAttributes().build());
        event.put(WHIRL_ENTITY, WhirlEntity.createAttributes().build());
    }
