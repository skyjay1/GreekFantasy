...
public class HarpyModel<T extends HarpyEntity> extends BipedModel<T> {
  ...
  @Override
  protected Iterable<ModelRenderer> bodyParts() { return ImmutableList.of(this.body, this.chest, this.tail, this.rightLeg, this.leftLeg, this.rightWing1, this.leftWing1, this.hat); }
