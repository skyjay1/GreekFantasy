...
public class ArachneModel<T extends ArachneEntity> extends BipedModel<T> {
    ...
    public Iterable<ModelRenderer> bodyParts() {
        return ImmutableList.of(body, bipedChest, hat, leftArm, rightArm, bipedBodyConnector, spiderNeck, spiderBody, spiderLeg1, spiderLeg2, spiderLeg3, spiderLeg4, spiderLeg5, spiderLeg6, spiderLeg7, spiderLeg8);
    }
