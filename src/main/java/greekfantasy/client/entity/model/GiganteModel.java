...
public class GiganteModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public static MeshDefinition createMesh(CubeDeformation cubeDeformation) {
        ...
        PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -2.0F, -5.0F, 10.0F, 10.0F, 10.0F, cubeDeformation), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition hat = partdefinition.addOrReplaceChild("hat", CubeListBuilder.create()
                .texOffs(40, 0).addBox(-5.0F, -2.0F, -5.0F, 10.0F, 10.0F, 10.0F, cubeDeformation.extend(0.5F))
                .texOffs(30, 0).addBox(-5.0F, 8.0F, -5.5F, 10.0F, 7.0F, 0.0F, cubeDeformation.extend(0.5F, 0.5F, 0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(64, 20).addBox(0.0F, -2.0F, -6.0F, 6.0F, 16.0F, 6.0F, cubeDeformation), PartPose.offset(6.0F, -6.0F, 3.0F));
        partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 20).addBox(-6.0F, -2.0F, -6.0F, 6.0F, 16.0F, 6.0F, cubeDeformation), PartPose.offset(-6.0F, -6.0F, 3.0F));

        partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(64, 42).addBox(-3.0F, 0.0F, -6.0F, 6.0F, 16.0F, 6.0F, cubeDeformation), PartPose.offset(3.0F, 8.0F, 3.0F));
        partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(40, 42).addBox(-3.0F, 0.0F, -6.0F, 6.0F, 16.0F, 6.0F, cubeDeformation), PartPose.offset(-3.0F, 8.0F, 3.0F));
