...
public class AutomatonCrackinessLayer<T extends Automaton, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    private static final ResourceLocation[] CRACKINESS = {
            new ResourceLocation(GreekFantasy.MODID, "textures/entity/automaton/automaton_crackiness_high.png"),
            new ResourceLocation(GreekFantasy.MODID, "textures/entity/automaton/automaton_crackiness_medium.png"),
            new ResourceLocation(GreekFantasy.MODID, "textures/entity/automaton/automaton_crackiness_low.png")
    };
